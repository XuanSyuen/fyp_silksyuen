...
<body id="page-top">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h1 class="h3 mb-0 text-gray-800 display-7">New User</h1>
                                </div>
                                <div class="card-body p-5">
                                    ...
                                    <form method="POST" action="functions.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control numberOnly" id="mobile" name="mobile" placeholder="Enter Mobile" required>
                                                </div>
                                        ...
                                        <div class="my-3 text-center">
                                            <input class="btn btn-dark btnAction" type="submit" value="Create" name="create-user" />
                                            <input class="btn btn-secondary btnAction" type="reset"  name="Clear" value="Clear" />
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('a[href="new-user.php"]').addClass('active');
